...
urlpatterns = [
    ...
    path('identity-availability/', views.VendorIdentityAvailabilityView.as_view(), name='vendor-identity-availability'),
    ...
    path('<uuid:pk>/recommendations/', views.VendorRecommendationsView.as_view(), name='vendor-recommendations'),
