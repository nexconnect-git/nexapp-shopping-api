...
from helpers.upload_paths import DeliveryPartnerDocumentUploadPath
...
class DeliveryPartner(models.Model):
    ...
    id_proof = models.FileField(upload_to=DeliveryPartnerDocumentUploadPath('id_proof'), blank=True, null=True)
