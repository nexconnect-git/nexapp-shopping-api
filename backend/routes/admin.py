...
from orders.views import (
    ...
    AdminCustomerContentBlockDetailView,
    AdminCustomerContentBlockListCreateView,
    AdminOrderListView,
...
urlpatterns = [
    ...
    path('vendors/<uuid:pk>/documents/', AdminVendorDocumentListCreateView.as_view(), name='admin-vendor-documents'),
    path('vendors/<uuid:pk>/documents/<uuid:doc_id>/verify/', AdminVendorDocumentVerifyView.as_view(), name='admin-vendor-document-verify'),
    ...
    path('delivery/orders/<uuid:pk>/reassign/', AdminDeliveryReassignView.as_view(), name='admin-delivery-reassign'),
    ...
    path('customer-content-blocks/', AdminCustomerContentBlockListCreateView.as_view(), name='admin-customer-content-blocks'),
    path('customer-content-blocks/<uuid:pk>/', AdminCustomerContentBlockDetailView.as_view(), name='admin-customer-content-block-detail'),
    ...
    path('fulfillment-nodes/', AdminFulfillmentNodeListCreateView.as_view(), name='admin-fulfillment-nodes'),
    path('fulfillment-nodes/<uuid:pk>/', AdminFulfillmentNodeDetailView.as_view(), name='admin-fulfillment-node-detail'),
    path('fulfillment-nodes/<uuid:node_id>/service-areas/', AdminFulfillmentNodeServiceAreaListCreateView.as_view(), name='admin-fulfillment-node-service-areas'),
    path('fulfillment-service-areas/<uuid:pk>/', AdminFulfillmentNodeServiceAreaDetailView.as_view(), name='admin-fulfillment-node-service-area-detail'),
    path('fulfillment-nodes/<uuid:node_id>/inventory/', AdminFulfillmentNodeInventoryListCreateView.as_view(), name='admin-fulfillment-node-inventory'),
    path('fulfillment-inventory/<uuid:pk>/', AdminFulfillmentNodeInventoryDetailView.as_view(), name='admin-fulfillment-node-inventory-detail'),
    path('fulfillment-reports/stock-comparison/', AdminFulfillmentStockComparisonView.as_view(), name='admin-fulfillment-stock-comparison'),
    path('fulfillment-reports/cart-events/', AdminCartFulfillmentAuditReportView.as_view(), name='admin-cart-fulfillment-audit-report'),
    path('fulfillment-reports/readiness/', AdminFulfillmentReadinessReportView.as_view(), name='admin-fulfillment-readiness-report'),
    path('fulfillment-rollout/prepare/', AdminFulfillmentRolloutPrepareView.as_view(), name='admin-fulfillment-rollout-prepare'),
    path('fulfillment-reservations/reconcile/', AdminFulfillmentReservationReconcileView.as_view(), name='admin-fulfillment-reservation-reconcile'),
