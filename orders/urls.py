...
urlpatterns = [
    ...
    path('cart/fulfillment/', views.RefreshCartFulfillmentView.as_view(), name='cart-fulfillment-refresh'),
    path('cart/fulfillment/events/', views.CartFulfillmentEventView.as_view(), name='cart-fulfillment-event'),
    ...
    path('page-features/', views.PageFeatureConfigView.as_view(), name='page-feature-config'),
    path('customer-app/content-config/', views.CustomerContentConfigView.as_view(), name='customer-content-config'),
    ...
    # Order Issues
    path('issues/options/', views.IssueOptionsView.as_view(), name='issue-options'),
